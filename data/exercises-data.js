      ...
      "levels": [
        {
          ...
          "questions": [
            ...
            },
            {
              ...
              "scenario": "A character leaves camp at ({{start_x}}, {{start_y}}, {{start_z}}) and walks {{dx}} meters east, {{dy}} meters up, and {{dz}} meters north. What is their new position?",
          ...
          "questions": [
            {
              ...
              "scenario": "A player runs at {{speed}} m/s at an angle of {{angle}}\u00b0 from the positive x-axis (measured counter-clockwise). Decompose their velocity into x and y components. Give as (vx, vy, 0). Round to 2 decimals.",
