const HistoryView = {
  render(container, folderId, noteName) {
    ...
    var html = '<a href="javascript:void(0)" class="back-link" onclick="router.navigate(\'#/folder/' + encodeURIComponent(folderId) + '/note/' + encodeURIComponent(noteName) + '/summary\')">\u2190 Back</a>';
