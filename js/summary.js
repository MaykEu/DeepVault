...
'<button class="btn btn-outline" onclick="sessionStorage.removeItem(\'dv_last_result\');router.navigate(\'#/folder/' + encodeURIComponent(state.folderId) + '/note/' + encodeURIComponent(state.noteName) + '/quiz\')">\u{1F504} Try Again</button>' +
          reviewBtn +
