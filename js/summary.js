...
'<button class="btn btn-outline" onclick="sessionStorage.setItem(\'dv_fresh_start\',\'1\');router.navigate(\'#/folder/' + encodeURIComponent(state.folderId) + '/note/' + encodeURIComponent(state.noteName) + '/quiz\')">\u{1F504} Try Again</button>' +
          reviewBtn +
